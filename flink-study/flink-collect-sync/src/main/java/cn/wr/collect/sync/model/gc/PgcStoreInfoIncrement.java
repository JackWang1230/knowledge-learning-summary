...
@Data
@Table(name = "pgc_store_info_increment")
@JsonIgnoreProperties(ignoreUnknown = true)
public class PgcStoreInfoIncrement implements Model {
    ...
    @Correspond(field = {EsFieldConst.location})
    ...
    public PgcStoreInfoIncrement convert(ResultSet rs) throws SQLException {
