package cn.wr.collect.sync.redis;
...
import cn.wr.collect.sync.model.middledb.PgcStoreInfoShortInit;
...
//     * @return
//     */
//    public <T> List<T> queryHashList(String table, Class<T> clazz, Object... keysVal) {
//        if (Arrays.stream(keysVal).anyMatch(Objects::isNull)) {
//            return Collections.emptyList();
//        }
//        String key = RedisConst.buildKey(table, keysVal);
//        try {
//            Map<String, String> map = hgetAll(key);
//            if (Objects.isNull(map)) {
//                return Collections.emptyList();
//            }
//            return map.values().stream().map(s -> JSON.parseObject(s, clazz))
//                    .filter(Objects::nonNull)
//                    .collect(Collectors.toList());
//        }
//        catch (Exception e) {
//            log.error("RedisService queryHashList: {} key: {}", table, key);
//        }
//        return Collections.emptyList();
//    }
//
...
//     * @return
//     */
//    public <T> T queryHash(String table, Class<T> clazz, Object... keysFieldVal) {
//        if (Arrays.stream(keysFieldVal).anyMatch(Objects::isNull)) {
//            return null;
//        }
//        String key = RedisConst.buildKey(table, keysFieldVal);
//        // key / field 均以不定长数组传入，倒序，暂时仅支持field字段长度为1
//        List<Object> forField = Arrays.asList(keysFieldVal);
//        Collections.reverse(forField);
//        String field = RedisConst.buildFiled(table, forField.toArray());
...
//     * @return
//     */
//    public PriceStore queryPriceStore(Long merchantId, Long storeId) {
//        if (Objects.isNull(merchantId) || Objects.isNull(storeId)) {
//            return null;
//        }
//        return this.queryHash(TableEnum.price_store.name(), PriceStore.class, merchantId, storeId);
//    }
//
//    /**
//     * price_store
...
//     * @return
//     */
//    public List<PriceStore> queryPriceStore(Long merchantId) {
//        if (Objects.isNull(merchantId)) {
//            return Collections.emptyList();
//        }
//        return this.queryHashList(TableEnum.price_store.name(), PriceStore.class, merchantId);
//    }
//
//    /**
//     * price_list
...
//     * @return
//     */
//    public PriceList queryPriceList(Long merchantId, String listId) {
//        if (Objects.isNull(merchantId) || StringUtils.isBlank(listId)) {
//            return null;
//        }
//        return this.queryHash(TableEnum.price_list.name(), PriceList.class, merchantId, listId);
//    }

    public static void main(String[] args) {
        /*RedisPoolUtil.initGoodsCenterPool(ExecutionEnvUtil.PARAMETER_TOOL);
        Jedis jedis = RedisPoolUtil.instance(RedisPoolUtil.DataBase.GoodsCenter, ExecutionEnvUtil.PARAMETER_TOOL);
        jedis.sadd("NeedRefresh:NoDel", "6666");
        RedisPoolUtil.closeGoodsCenterConn(jedis);
        RedisPoolUtil.closePool();*/

        /*RedisService redisService = new RedisService(ExecutionEnvUtil.PARAMETER_TOOL);
        Long addHash = redisService.addHash("test0622", "test", "10");
        System.out.println("addHash:" + addHash);
        Long hincr = redisService.hincrBy("test0622", "test", 1);
        System.out.println("hincr:" + hincr);
        Boolean exists = redisService.exists("test0622");
        System.out.println("exists:" + exists);
        Long expire = redisService.expire("test0622", 20);
        System.out.println("expire:" + expire);

        System.out.println(String.valueOf(LocalDateTime.now()));*/

        /*String set = redisService.set("testExpire", "test", "EX", 30);
        System.out.println("............." + set);*/
        /*List<PgcMerchantInfo> pgcMerchantInfos = redisService.queryPgcMerchantInfo(151);

        System.out.println(JSON.toJSONString(pgcMerchantInfos));*/
//        redisService.clearRedis(REDIS_GOODS_ALL);

        Jedis jedis = RedisPoolUtil.getInstance(ExecutionEnvUtil.PARAMETER_TOOL);
//        GoodsCenterTime time = new GoodsCenterTime();
//        time.setDbId(1);
//        time.setMerchantId(2);
//        time.setGoodsInternalId("3");
//        jedis.sadd(REDIS_GOODS_CENTER, JSON.toJSONString(time));

        String skuCode = "143232-132132-02-1112333";
        String value = Compute.priceRedisKey(skuCode, new BigDecimal(0), new BigDecimal(0));
