...
public class DingTalkUtil {
    ...
    public static String sendPost(String url, Map<String, Object> param, Map<String, String> headParam) {
        ...
        try {
            ...
            logger.error("DingTalkUtil.sendPost: " + e);
            e.printStackTrace();
        }
        //使用finally块来关闭输出流、输入流
            ...
            try {
                ...
                logger.error("DingTalkUtil.sendPost: " + ex);
                ex.printStackTrace();
            }
        }
        return result;
    ...
    public static void operateJob(String url, String job, String env, String operate) {
        ...
        text.put("job", job + "\n"
                ...
                + "operate: " + operate );
        json.put("text", text);
        logger.info("DingTalkUtil startJob url:{}, params:{}", url, json);
        String result = sendPostByMap(url, json);
        logger.info("DingTalkUtil startJob url:{}, params:{}, result:{}", url, json, result);
    }
    ...
    public static void sendDingDingWithSecret(String postUrl, String secret, String title, String msg) {
        try {
            ...
            // 发送post请求
            logger.info("DingTalkUtil ding talk, json:{}", json);
            String url = String.format(postUrl, timestamp, sign);
            String result = DingTalkUtil.sendPostByMap(url, json);
            logger.info("DingTalkUtil ding talk, url:{}, json:{} result:{}", url, json, result);
        }
        catch (Exception e) {
            logger.error("DingTalkUtil Exception:{}", e);
        }
    }
}
